...
public interface Mm2Package extends EPackage {
	 ...
	 * @ordered
	 */
	int PAGE_QUESTION___BOUTON_RETOUR_INTERDIT__DIAGNOSTICCHAIN_MAP = NAVIGABLE_OPERATION_COUNT + 0;

	/**
	 * The operation id for the '<em>Visibilite Btn Suivant</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PAGE_QUESTION___VISIBILITE_BTN_SUIVANT__DIAGNOSTICCHAIN_MAP = NAVIGABLE_OPERATION_COUNT + 1;
	...
	/**
	 * The operation id for the '<em>Suivant Impossible</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PAGE_SOUMISSION___SUIVANT_IMPOSSIBLE__DIAGNOSTICCHAIN_MAP = NAVIGABLE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PAGE_SOUMISSION_OPERATION_COUNT = NAVIGABLE_OPERATION_COUNT + 1;
	...
	/**
	 * Returns the meta object for the '{@link mm2.PageQuestion#boutonRetourInterdit(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Bouton Retour Interdit</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Bouton Retour Interdit</em>' operation.
	 * @see mm2.PageQuestion#boutonRetourInterdit(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getPageQuestion__BoutonRetourInterdit__DiagnosticChain_Map();

	/**
	 * Returns the meta object for the '{@link mm2.PageQuestion#visibiliteBtnSuivant(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Visibilite Btn Suivant</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Visibilite Btn Suivant</em>' operation.
	 * @see mm2.PageQuestion#visibiliteBtnSuivant(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getPageQuestion__VisibiliteBtnSuivant__DiagnosticChain_Map();
	...
	/**
	 * Returns the meta object for the '{@link mm2.PageSoumission#suivantImpossible(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Suivant Impossible</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Suivant Impossible</em>' operation.
	 * @see mm2.PageSoumission#suivantImpossible(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
	EOperation getPageSoumission__SuivantImpossible__DiagnosticChain_Map();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation PAGE_QUESTION___BOUTON_RETOUR_INTERDIT__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getPageQuestion__BoutonRetourInterdit__DiagnosticChain_Map();

		/**
		 * The meta object literal for the '<em><b>Visibilite Btn Suivant</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PAGE_QUESTION___VISIBILITE_BTN_SUIVANT__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getPageQuestion__VisibiliteBtnSuivant__DiagnosticChain_Map();
		...
		/**
		 * The meta object literal for the '<em><b>Suivant Impossible</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PAGE_SOUMISSION___SUIVANT_IMPOSSIBLE__DIAGNOSTICCHAIN_MAP = eINSTANCE
				.getPageSoumission__SuivantImpossible__DiagnosticChain_Map();
