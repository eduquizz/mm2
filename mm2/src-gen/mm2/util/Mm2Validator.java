...
public class Mm2Validator extends EObjectValidator {
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Btn Retour' of 'Page Question'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int PAGE_QUESTION__BTN_RETOUR = 6;

	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Btn Suivant' of 'Page Question'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int PAGE_QUESTION__BTN_SUIVANT = 7;

	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Btn Retour' of 'Page Soumission'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int PAGE_SOUMISSION__BTN_RETOUR = 8;

	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Btn Suivant' of 'Page Soumission'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int PAGE_SOUMISSION__BTN_SUIVANT = 9;
	 ...
	 * @generated
	 */
	public static final int QUESTION__ENNONCE_PAS_VIDE = 10;

	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Reponse Non Vide' of 'Reponse'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final int REPONSE__REPONSE_NON_VIDE = 11;
	...
	public boolean validatePageQuestion(PageQuestion pageQuestion, DiagnosticChain diagnostics,
		...
		if (result || diagnostics != null)
			result &= validatePageQuestion_btnSuivant(pageQuestion, diagnostics, context);
		if (result || diagnostics != null)
			result &= validatePageQuestion_btnRetour(pageQuestion, diagnostics, context);
		return result;
	}

	/**
	 * Validates the btnSuivant constraint of '<em>Page Question</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validatePageQuestion_btnSuivant(PageQuestion pageQuestion, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		return pageQuestion.btnSuivant(diagnostics, context);
	}

	/**
	 * Validates the btnRetour constraint of '<em>Page Question</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validatePageQuestion_btnRetour(PageQuestion pageQuestion, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		return pageQuestion.btnRetour(diagnostics, context);
	}
	...
	public boolean validatePageSoumission(PageSoumission pageSoumission, DiagnosticChain diagnostics,
		...
		if (result || diagnostics != null)
			result &= validatePageSoumission_btnSuivant(pageSoumission, diagnostics, context);
		if (result || diagnostics != null)
			result &= validatePageSoumission_btnRetour(pageSoumission, diagnostics, context);
		return result;
	}

	/**
	 * Validates the btnSuivant constraint of '<em>Page Soumission</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validatePageSoumission_btnSuivant(PageSoumission pageSoumission, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		return pageSoumission.btnSuivant(diagnostics, context);
	}

	/**
	 * Validates the btnRetour constraint of '<em>Page Soumission</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validatePageSoumission_btnRetour(PageSoumission pageSoumission, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		return pageSoumission.btnRetour(diagnostics, context);
	}
	...
	public boolean validateReponse(Reponse reponse, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(reponse, diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(reponse, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(reponse, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryReferenceIsContained(reponse, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryBidirectionalReferenceIsPaired(reponse, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(reponse, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(reponse, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryKeyUnique(reponse, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(reponse, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateReponse_reponseNonVide(reponse, diagnostics, context);
		return result;
	}

	/**
	 * Validates the reponseNonVide constraint of '<em>Reponse</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateReponse_reponseNonVide(Reponse reponse, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		return reponse.reponseNonVide(diagnostics, context);
	}
