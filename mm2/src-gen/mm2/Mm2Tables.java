...
public class Mm2Tables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ CollectionTypeId SET_CLSSid_PageSoumission = TypeId.SET.getSpecializedId(Mm2Tables.CLSSid_PageSoumission, true, ValueUtil.ZERO_VALUE, ValueUtil.UNLIMITED_VALUE);
	...
	public static class Properties {
		...
		public static final ExecutorProperty _BoutonRetour__PageSoumission__boutonRetour = new ExecutorPropertyWithImplementation("PageSoumission", Types._BoutonRetour, 1, new EcoreLibraryOppositeProperty(Mm2Package.Literals.PAGE_SOUMISSION__BOUTON_RETOUR));
		...
		public static final ExecutorProperty _PageSoumission__boutonRetour = new EcoreExecutorProperty(Mm2Package.Literals.PAGE_SOUMISSION__BOUTON_RETOUR, Types._PageSoumission, 0);
		public static final ExecutorProperty _PageSoumission__boutonSoumettre = new EcoreExecutorProperty(Mm2Package.Literals.PAGE_SOUMISSION__BOUTON_SOUMETTRE, Types._PageSoumission, 1);
		public static final ExecutorProperty _PageSoumission__question = new EcoreExecutorProperty(Mm2Package.Literals.PAGE_SOUMISSION__QUESTION, Types._PageSoumission, 2);
	...
	public static class FragmentProperties {
		...
		private static final ExecutorProperty /*@NonNull*/ [] _PageSoumission = {
			Mm2Tables.Properties._PageSoumission__boutonRetour,
