...
/**
 * This is the item provider adapter for a {@link mm2.Questionnaire} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QuestionnaireItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNomPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Questionnaire_nom_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Questionnaire_nom_feature",
								"_UI_Questionnaire_type"),
						Mm2Package.Literals.QUESTIONNAIRE__NOM, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Mm2Package.Literals.QUESTIONNAIRE__PAGE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Mm2Package.Literals.QUESTIONNAIRE__PAGE,
				Mm2Factory.eINSTANCE.createPageQuestion()));

		newChildDescriptors.add(createChildParameter(Mm2Package.Literals.QUESTIONNAIRE__PAGE,
				Mm2Factory.eINSTANCE.createPageSoumission()));

		newChildDescriptors.add(createChildParameter(Mm2Package.Literals.QUESTIONNAIRE__PAGE,
				Mm2Factory.eINSTANCE.createPageResultat()));
	}
