 ...
 * @generated
 */
public class PageResultatItemProvider extends PageItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PageResultatItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PageResultat"));
	}
	...
	public String getText(Object object) {
		String label = ((PageResultat) object).getTitre();
		return label == null || label.length() == 0 ? getString("_UI_PageResultat_type")
				: getString("_UI_PageResultat_type") + " " + label;
	}
